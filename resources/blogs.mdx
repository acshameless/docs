...
- [官方资料](https://docs.pytorch.org/docs/main/quantization.html#introduction-to-quantization)
- [PyTorch的量化](https://fabiensanglard.net/cuda/index.html)
- [PyTorch的量化实战项目](https://github.com/Laicheng0830/Pytorch_Model_Quantization/blob/main/pose_estimation.py)
